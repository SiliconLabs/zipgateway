...
/* How many bytes are passed at a time when writing in the NVM via the SerialAPI */
 ...
 * \param chiptype Type of chip to write to ZW_GECKO_CHIP_TYPE (700 series) or ZW_CHIP_TYPE (500 series)
 */
